...
function About() {
    ...
    return (
        <motion.div
            ...
            <h3 className='absolute top-24 uppercase tracking-[12px] text-gray-700 dark:text-gray-500 text-xl md:text-2xl'>
                about
            </h3>
            <motion.img
                initial={{
            ...
            <div className='flex flex-col px-0 -mt-3 md:mt-16 md:px-5 '>
                ...
                <p className='text-sm md:text-lg mt-3 font-thin leading-relaxed tracking-wide text-justify'>
